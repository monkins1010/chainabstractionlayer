...
import { Address, Transaction, TxStatus, BigNumber } from '@liquality/types'
import { InvalidAddressError } from '@liquality/errors'
import { VerusNetwork, UTXO, Input, Output, Transaction as VerusTransaction } from './types';
...
function decodeRawTransaction(hex: string, network: VerusNetwork = verus.networks.verus): VerusTransaction {
...
function validateAddress(_address: Address | string, network: VerusNetwork) {
